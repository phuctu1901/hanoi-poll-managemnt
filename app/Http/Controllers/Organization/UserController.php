...
//            'isActive'=>$data['isActive']
    ...
    public function addRequest(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return redirect('/organization/user/add')->withErrors($validator)->withInput();
        } else {
            // Dữ liệu vào hợp lệ sẽ thực hiện tạo người dùng dưới csdl
            if ($this->create($allRequest)) {
                // Insert thành công sẽ hiển thị thông báo
                Session::flash('success', 'Đăng ký thành viên thành công!');
                return redirect('/organization/user');
            } else {
                // Insert thất bại sẽ hiển thị thông báo lỗi
                Session::flash('error', 'Đăng ký thành viên thất bại!');
                return redirect('/organization/user/add');
            }
        }
    }
    ...
    public function editView($user_id)
    {
        ...
        return view('organization.user.edit', ['user' => $user, 'roles'=>$roles]);
    }
    ...
    {
        $user = User::find($user_id);
        return view('organization.user.detail', ['user' => $user]);
    }

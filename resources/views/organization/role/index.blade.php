                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a type="button" name="add" id="add" class="btn btn-success pull-right"
                                   style="display: inline-block" href="/organization/role/add">Thêm loại tài khoản
                                </a>
                            </div>
                            <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="success p-0" data-original-title="" title=""
                                                       href="/organization/role/edit/{{$role->id}}">
...
{{--                                    @can('Quản lý quyền')--}}
                                    <a type="button" name="add" id="add" class="btn btn-success pull-right"
                                       style="display: inline-block" href="/organization/permission/add">Thêm quyền
                                    </a>
{{--                                    @endcan--}}
                                </div>
                                <div class="card-body">
                                        ...
                                        <table class="table table-responsive-md-md text-center table-striped">
                                            ...
                                            @foreach($permissions as $permission)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="success p-0" data-original-title="" title=""
                                                           href="/organization/permission/edit/{{$role->id}}">
                                                            <i class="ft-edit-2 font-medium-3 mr-2"></i>
                                                        </a>

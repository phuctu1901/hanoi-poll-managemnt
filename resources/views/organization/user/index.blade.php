                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a type="button" name="add" id="add" class="btn btn-success pull-right"
                                   style="display: inline-block" href="/organization/user/add">Thêm người dùng
                                </a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-responsive-md-md text-center table-striped">
                                        ...
                                        @foreach($users as  $user)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="info p-0" data-original-title="" title=""  href="/organization/user/detail/{{$user->id}}">
                                                        <i class="ft-info font-medium-3 mr-2"></i>
                                                    </a>
                                                    <a class="success p-0" data-original-title="" title=""  href="/organization/user/edit/{{$user->id}}">
                                                        <i class="ft-edit-2 font-medium-3 mr-2"></i>
                                                    </a>
                                                    <a class="danger p-0" data-original-title="" title="" href="/organization/user/delete/{{$user->id}}">
                                                        <i class="ft-x font-medium-3 mr-2"></i>
                                                    </a>
                                                    <a class="danger p-0" data-original-title="" title="" href="/organization/user/logout/{{$user->id}}">
